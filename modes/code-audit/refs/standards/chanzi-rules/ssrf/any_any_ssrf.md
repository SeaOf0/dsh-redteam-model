...
> 规则 ID：`any_any_ssrf` · 类别：ssrf · 关键 sink：AbstractHttpClient, AbstractRequestBuilder, AsyncRestTemplate, BasicDataSource, Call, Client, CloseableHttpAsyncClient, CloseableHttpClient, DataSource, DocumentBuilder, DocumentBuilderFactory, DriverManager
