...
> 规则 ID：`any_any_upload` · 类别：upload · 关键 sink：BufferedOutputStream, ByteSource, File, FileItem, FileOutputStream, FileUploadService, FileUtils, FileWriter, Files, IOUtils, ServletFileUpload, StorageService
