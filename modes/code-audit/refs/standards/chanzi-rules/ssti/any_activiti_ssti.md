...
> 规则 ID：`any_activiti_ssti` · 类别：ssti · 关键 sink：DeploymentBuilder, ExpressionManager, RepositoryService, RuntimeService, TaskService, createDeployment, deploy, executeScriptTask, resolveExpression, saveModel, saveModelWithEditorSource, startProcessInstanceById
