...
> 规则 ID：`other_any_pathtraver` · 类别：traversal · 关键 sink：File, FileInputStream, FileReader, FileSystemResource, FileUtils, Files, HttpServletResponse, IOUtils, RandomAccessFile, Resource, ResourceLoader, Scanner
