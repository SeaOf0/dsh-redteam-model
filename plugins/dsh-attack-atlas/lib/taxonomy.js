		...
		categories: [
			...
			},
			{
				...
				items: [
					...
					{ id: "sqli", label: "SQL 注入", ref: "lang/code-audit-java.md" },
					{ id: "deser", label: "反序列化", ref: "lang/code-audit-java.md" },
					{ id: "file-rw", label: "文件读写", ref: "lang/code-audit-php.md" },
					{ id: "ssrf", label: "SSRF", ref: "lang/code-audit-java.md" },
					{ id: "xxe", label: "XXE", ref: "lang/code-audit-java.md" },
					{ id: "ssti", label: "SSTI/模板", ref: "lang/code-audit-java.md" },
					{ id: "path", label: "路径穿越", ref: "lang/code-audit-php.md" },
