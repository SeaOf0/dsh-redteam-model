...
const DELIVERED = new Set(["dsh-stage-gate", "dsh-mcp-studio", "dsh-product-subagents", "dsh-route-boost", "dsh-refusal-guard", "dsh-sec-enforce", "dsh-redteam-results", "dsh-hunter", "dsh-mode-group", "dsh-scanner-tools"]);
